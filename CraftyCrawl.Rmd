...
google_map(key = MapKey, styles = mystyle, search_box = TRUE) %>%
...
# # this is worse
# distancematrix <- data.frame(drivingMatrix$Distance)
# distancematrix <- distancematrix[,-1]
# distance.mx <- as.matrix(distancematrix)
# colnames(distance.mx) <- NULL
# rownames(distance.mx) <- NULL
...
distance.mx <- replace(distance.mx, distance.mx == 1185, 1184)
isSymmetric.matrix(distance.mx)
...
# Directions
Directions <- apply(combo, 1, function(x){
