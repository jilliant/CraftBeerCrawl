...
source("~/Desktop/SomethingWithNumbers/BeerMap/key.R")
...
```{r, include=FALSE}
# load data
Breweries <- read_csv("BestBrewery.csv")
QldBar <- read_csv("QldBar.csv")
NswBar <- read_csv("NswBar.csv")
ActBar <- read_csv("ActBar.csv")
VicBar <- read_csv("VicBar.csv")
TasBar <- read_csv("TasBar.csv")
SABar <- read_csv("SaBar.csv")
WABar <- read_csv("WaBar.csv")
...
# save(geocoded.CraftBeerAU, file = "geocodedCraftBeerAu.rdata")
...
#save(CraftBeerAu_geocoded, file = "DIYgeocodedCraftBeerAu.rdata")
...
```{r}
load("DIYgeocodedCraftBeerAu.rdata")
...
IconCraft <- makeIcon(iconUrl = "beer-1.png",
                      iconAnchorX = 18, iconAnchorY = 12)
IconBrew <- makeIcon(iconUrl = "barrel-3.png",
                    iconAnchorX = 18, iconAnchorY = 12)
IconBar <- makeIcon(iconUrl = "beer-2.png",
                    iconAnchorX = 18, iconAnchorY = 12)
